...
Para que tengáis una mejor idea, os adjuntamos la [parte teórica en PDF]({{ page.root }}{% link files/BBDD-Master2024_2025.pdf %}){:target="_blank"} para que podáis verla cuando queráis.

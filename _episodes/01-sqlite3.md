...
Para que tengáis una mejor idea, os adjuntamos la [parte teórica en PDF]({{ page.root }}{% link files/BBDD_Master2025-2026.pdf %}){:target="_blank"} para que podáis verla cuando queráis.

...
Para ello vamos a [descargar]({{ page.root }}/files/uniprotInsert.py) el siguiente programa y lo iremos comentando juntos [uniprotInsert.py]({{ page.root }}/files/uniprotInsert_py.html) 
